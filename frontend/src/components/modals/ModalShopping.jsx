...
const ShoppingModal = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.shopping_number?.trim()) {
      newErrors.shopping_number = "El número de compra es requerido";
    }
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-transparent text-slate-800 placeholder-slate-400 ${
                      errors.shopping_number ? "border-red-400 bg-red-50" : "border-gray-200"
                    }`}
                    placeholder="Ej: COM-001"
                    value={formData.shopping_number || ""}
                    onChange={(e) => {
                      setFormData({ ...formData, shopping_number: e.target.value });
                      if (errors.shopping_number) {
                        setErrors(prev => ({ ...prev, shopping_number: undefined }));
                      }
                    }}
                  />
                  {errors.shopping_number && (
                    <p className="text-red-500 text-xs mt-1 flex items-center gap-1">
                      <AlertCircle size={12} /> {errors.shopping_number}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="date"
                      className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-transparent text-slate-800 ${
                  ...
                  <div className="relative">
                    ...
                    <select
                      className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-transparent text-slate-800 appearance-none ${
                        errors.user_id ? "border-red-400 bg-red-50" : "border-gray-200"
                      }`}
